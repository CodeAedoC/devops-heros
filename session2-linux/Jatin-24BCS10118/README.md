...
Name: Jatin Mangtani Enrollment Number: 24BCS10118
...
Output
total 0
16325548650738247 -rwxrwxrwx 2 jatin jatin 12 Sep  4 16:03 hard.txt
16325548650738247 -rwxrwxrwx 2 jatin jatin 12 Sep  4 16:03 original.txt
43065671436955513 lrwxrwxrwx 1 jatin jatin 12 Sep  4 16:03 soft.txt -> original.txt
...
$ ls -li
# total 0
# 16325548650738247 -rwxrwxrwx 1 jatin jatin 12 Sep  4 16:03 hard.txt
# 43065671436955513 lrwxrwxrwx 1 jatin jatin 12 Sep  4 16:03 soft.txt -> original.txt
...
Sep 04 16:44:19 DESKTOP-E012345 systemd[1]: Starting ssh.service - OpenBSD Secure Shell server...
Sep 04 16:44:19 DESKTOP-E012345 sshd[1230]: Server listening on 0.0.0.0 port 22.
Sep 04 16:44:19 DESKTOP-E012345 sshd[1230]: Server listening on :: port 22.
Sep 04 16:44:19 DESKTOP-E012345 systemd[1]: Started ssh.service - OpenBSD Secure Shell server.
Output — View boot logs
journalctl -b -n 30
Sep 04 16:43:20 DESKTOP-E012345 kernel: Linux version 6.18.33.2-microsoft-standard-WSL2 (root@f1bbfb02316b) (gcc (GCC) 13.2.0, GNU ld (GNU Binutils) 2.41) #1 SMP PREEMPT_DYNAMIC Thu Jun 18 21:54:43 UTC 2026
Sep 04 16:43:20 DESKTOP-E012345 kernel: Command line: initrd=\initrd.img WSL_ROOT_INIT=1 panic=-1 nr_cpus=16 hv_utils.timesync_implicit=1 console=hvc0 debug pty.legacy_count=0 WSL_ENABLE_CRASH_DUMP=1
Sep 04 16:43:20 DESKTOP-E012345 kernel: KERNEL supported cpus:
Sep 04 16:43:20 DESKTOP-E012345 kernel:   Intel GenuineIntel
Sep 04 16:43:20 DESKTOP-E012345 kernel:   AMD AuthenticAMD
